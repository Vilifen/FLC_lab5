...
![vivod.png](ui/photo/vivod.png)

# Тестовые примеры
Пример вывода ошибок
![oshibki.png](ui/photo/oshibki.png)

Пример AST при одном цикле с ошибкой (вывод AST для циклов без ошибок)
![tri.png](ui/photo/tri.png)

Визуализация AST
![grafik.png](ui/photo/grafik.png)

# Инструкция по запуску

Программа распознает лексические, синтаксические и семантические ошибки. Выводит таблицу ошибок, а так же строит дерево AST, которое можно скачать в json формате или посмотреть его визуализацию.

Для успешной работы проекта понадобится Python 3.9 или выше, pip, PyQt6. 

Для сборки проекта в .exe необходим PyInstaller: 
* нужно установить его через pip install pyinstaller
* выполнить команду pyinstaller --onefile --windowed --name "FLC" main.py в терминале 
* после сборки исполняемый .exe файл появится в папке dist.

Чтобы программа начала работать необходимо написать цикл while на языке PHP и нажать на пуск.